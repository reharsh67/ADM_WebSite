<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AskQueAgain.aspx.cs" Inherits="MyTestWebPage.Student.AskQueAgain" %>
   ...
   <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Post Query</h2>
                    <form method="POST" runat="server">
                                        <label> <a href="/Student/ViewQueryResp.aspx"><span class="required">Click here </span></a>to view Response!</label>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                        ...
                                        <asp:TextBox ID="EMAIL" Width="560px" class="input--style-4"  DataValueField="EmailId" runat="server" required ToolTip="Enter Email"></asp:TextBox>
                                        <br />
                                     </div>
                            </div>
                            <div class="col-2">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <center>
                                         <asp:Button ID="Button1" runat="server" onclick="Post_Query" class="btn btn--radius-2 btn--blue"   Text="Submit" >   </asp:Button>
                                   </center>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  <button type="button" class="btn btn-danger" onclick="window.location.href='/Student/AskQueAgain.aspx'" data-dismiss="modal">
                                                        OK</button>
                                                </div>
                                            </div>
                                        </div>
