                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="pass1"  class="input--style-4" Width="560px" type="password" DataValueField="password" required runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="pass"  class="input--style-4" Width="560px" type="password" DataValueField="password" required runat="server"></asp:TextBox>
