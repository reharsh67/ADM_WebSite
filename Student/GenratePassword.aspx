                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label>Enter Appid-Id</label>
                                    <asp:TextBox ID="uid" class="input--style-4" Width="560px" DataValueField="question" required runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="EMAIL" class="input--style-4" Width="560px" DataValueField="question" required runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="pass1" class="input--style-4" Width="560px" TextMode="Password" DataValueField="password" required runat="server"></asp:TextBox>
                                    
    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Password must contain special characters and lowe case and uppcase letters"   ValidationExpression="^.*(?=.{8,})(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!*@#$%^&+=]).*$"  ControlToValidate="pass1"></asp:RegularExpressionValidator> 
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="pass" class="input--style-4" Width="560px" TextMode="Password" DataValueField="password" required runat="server"></asp:TextBox>
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="pass1" ForeColor="Red" ControlToValidate="pass" ErrorMessage="Passwords must be same">
                        ...
                        <center>
                                         <asp:Button ID="Button1" runat="server"  class="btn btn--radius-2 btn--blue" OnClick="Save_Pass"   Text="Create" >   </asp:Button>
                                   </center>
    ...
    <div id="MyPopup1" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" onclick="window.location.href='/Student/GenratePassword.aspx'" data-dismiss="modal">
                        OK</button>
                </div>
            </div>
        </div>
