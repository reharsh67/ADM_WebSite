<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="MyTestWebPage.Student.ResetPassword" %>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="CurrPass"  class="input--style-4" Width="560px" DataValueField="question" required runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="NewPass"  class="input--style-4" Width="560px" type="password" DataValueField="password" required runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="Newpass1"  class="input--style-4" Width="560px" type="password" DataValueField="password" required runat="server"></asp:TextBox>
