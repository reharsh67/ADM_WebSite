<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CounsellingAfterLogin.aspx.cs" Inherits="MyTestWebPage.Student.CounsellingAfterLogin" %>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                        ...
                                        <asp:TextBox ID="txtSelectDate" class="input--style-4" runat="server" placeholder="mm/dd/yyyy" type="date" ReadOnly = "false" onclick="ToggleValidator(this);"></asp:TextBox>
